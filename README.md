## LAB-WEB-14-2026
Selamat datang di repositori LAB-WEB-14-2026! Repositori ini adalah tempat pengumpulan tugas praktikum untuk mata kuliah Praktikum Pemrograman Web 2026. Berikut adalah panduan singkat untuk mengumpulkan tugas di repositori ini.
...
```bash
cd LAB-WEB-14-2026
git checkout -b H071251nnn # Sesuaikan dengan NIM masing-masing, contoh: git checkout -b H071234567
```

6. **Masuk ke Folder**: Masuk ke directory/folder sesuai NIM.

```bash
cd H071251nnn # Sesuaikan dengan NIM masing-masing, contoh: cd H071234567
```
...
```bash
git push -u origin H071251nnn # Sesuaikan dengan NIM masing-masing, contoh: git push -u origin H071234567
```
